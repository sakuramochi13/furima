...
```bash
git clone git@github.com:sakuramochi13/furima.git
cd furima
```
...
![ER図](images/er-furima.drawio.png)
...
本アプリには、管理者ユーザーは存在しません。
一般ユーザーのテストアカウントは以下の通りです。

- **メールアドレス**：mikako.watanabe@example.org
- **パスワード**：password

※ factory によるランダム生成ユーザーも存在しますが、
これらのユーザーはメールアドレスがランダムであり、ログイン確認には使用できません。
